            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <legend > 
                            <h2>Blood Pressure </h2> ADD <button><a href="weight.php">+</a></button>
                   ...
                   <?php
                            ...
                            {
                                global $conn;
                                if ($stmt = $conn->prepare("SELECT para_date, para_time, reading, type  FROM `tracking_para`  where $id = ? and para_id = 3")) 
                                     {
